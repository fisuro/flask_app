    ...
    $('#subbutton').click(function(){
        ...
        $.ajax({
            ...
            success: function(data){
                for(var i in data){
                    var markup = "<tr><td>" + data[i].id + "</td><td>" + data[i].name + "</td><td>" + data[i].surname + "</td><td>" + data[i].email +"</td><td> <button type='button' class='edit' id='edit" + i + "' name='edituj'>Edit</button> <button  type='button' class='delete' id='delete" + data[i].id + "' name='obrisi'>Delete</button></td></tr>";
